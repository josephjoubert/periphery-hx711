...
class HX711:
    ...
    def __init__(self, dout, pd_sck, gain=128):
        ...
        self.gppio_sck = GPIO(self.PD_SCK, "out")

        # Setup the GPIO Pin as input
        #$GPIO.setup(self.DOUT, GPIO.IN)
        self.gppio_dout = GPIO(self.DOUT, "in")
    ...
    def set_gain(self, gain=128):
        ...
        #PIO.output(self.PD_SCK, False)
        self.gppio_sck.write(False)
        self.read()
    ...
    def read(self):
        ...
        while not (self.gppio_dout.read() == 0):
        ...
        for i in range(24):
            ...
            self.gppio_sck.write(True)
            count = count << 1
            #GPIO.output(self.PD_SCK, False)
            self.gppio_sck.write(False)
            #if(GPIO.input(self.DOUT)):
            if(self.gppio_dout.read()):
                count += 1
